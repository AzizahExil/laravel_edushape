...
<div class="col-md-6 mb-4">
    <div class="card">
        ...
        <div class="card-body">
            <h5 class="card-title">Learn Colors</h5>
            <p class="card-text">A fun way to learn colors for preschool kids.</p>
...
<script>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <h5 class="card-title">Math Basics</h5>
            <p class="card-text">Introduction to basic math concepts.</p>
            <button onclick="playVideo('video1')" class="btn btn-primary">Watch Now</button>
        </div>
    </div>
</div>
