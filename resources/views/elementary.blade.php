...
<body>
    ...
    <!-- <div class="row">
        ...
        <div class="content col-md-9"><br>
            ...
            <div class="row">
               <!-- Video 1: Pelajaran Matematika -->
            <div class="col-md-6 mb-4">
                <div class="card">
                    <div class="video-thumbnail">
                        <iframe src="https://www.youtube.com/embed/VMmPYQa2rts" allowfullscreen></iframe>
                    </div>
                    <div class="card-body">
                        <h5 class="card-title">Mengenal Bilangan Bulat</h5>
                        <p class="card-text">Pelajaran matematika tentang bilangan bulat untuk anak SD.</p>
                        <button onclick="playVideo('video1')" class="btn btn-primary">Tonton Sekarang</button>
                    </div>
                </div>
            </div>
            <!-- Video 2: Pelajaran IPA -->
            <div class="col-md-6 mb-4">
                <div class="card">
                    <div class="video-thumbnail">
                        <iframe src="https://www.youtube.com/embed/Vr8p_d7DJg8" allowfullscreen></iframe>
                    </div>
                    <div class="card-body">
                        <h5 class="card-title">Pengenalan Sifat-Sifat Air</h5>
                        <p class="card-text">Pelajaran IPA tentang sifat-sifat air untuk anak SD.</p>
                        <button onclick="playVideo('video2')" class="btn btn-primary">Tonton Sekarang</button>
                    </div>
                </div>
            </div>
            <!-- Video 3: Pelajaran Matematika -->
            <div class="col-md-6 mb-4">
                <div class="card">
                    <div class="video-thumbnail">
                        <iframe src="https://www.youtube.com/embed/VMmPYQa2rts" allowfullscreen></iframe>
