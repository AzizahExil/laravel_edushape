...
<body>
    ...
    <div class="card">
        <div class="video-thumbnail">
            <iframe id="video1" src="https://youtu.be/Fdl8WLeTy3o?si=P_incBnnDJXXILMi" allowfullscreen></iframe>
        </div>
        <div class="card-body">
...
<div class="col-md-6 mb-4">
    <div class="card">
        <div class="video-thumbnail">
            ...
            <iframe id="video2" src="https://youtu.be/r3sA-oSzcWM?si=N--4bYfvy646F7fs" allowfullscreen></iframe>
        </div>
        <div class="card-body">
            <h5 class="card-title">Petualangan Sains Ajaib</h5>
            <p class="card-text">Pelajaran IPA yang seru untuk anak SMP.</p>
            <button onclick="playVideo('video2')" class="btn btn-primary">Watch Now</button>
        </div>
    </div>
</div>
